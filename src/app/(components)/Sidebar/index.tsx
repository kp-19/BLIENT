...
import { Archive, CircleDollarSign, Clipboard, Layout, LucideIcon, Menu, SlidersHorizontal, UserSquareIcon } from 'lucide-react';
  ...
  return (
    <div className={SidebarClassNames}>
        ...
        <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
            <div>
            <Image
              src="https://w7.pngwing.com/pngs/530/987/png-transparent-electronics-electronic-circuit-hackerspace-computer-rayan-electronic-store-thumbtack-logo-microcontroller-project.png"
              alt="Profile"
              width={50}
              height={50}
        ...
        <div className={`${isSidebarCollapsed ? "hidden" : "block"}`}>
            <p className='text-center text-xs text-gray-500'>&copy; 2024 ElectroMart</p>
        </div>
    </div>
  )
}
